...
import 'package:whatsap_clone/CustomUI/addToCallCardScreen.dart';
...
class SelectContactForCall extends StatefulWidget {
  SelectContactForCall({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _SelectContactForCallState();
  }
}

class _SelectContactForCallState extends State<SelectContactForCall>{
  @override
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemBuilder: (context,i){
          ...
          return AddtoCallScreenCard(contact: contacts[i-2],);
        },
